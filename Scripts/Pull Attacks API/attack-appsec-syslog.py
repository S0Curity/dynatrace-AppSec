...
def get_dynatrace_vulnerabilities(api_token, base_url, last_pull_time, syslog_server, syslog_port):
    ...
    vulnerabilities_url = f"{base_url}/api/v2/attacks"
    ...
    params = {
        "from": last_pull_time,
        "fields": "+attackTarget,+securityProblem,+request,+entrypoint,+vulnerability,+attacker,+managementZones,+affectedEntities",
    }
